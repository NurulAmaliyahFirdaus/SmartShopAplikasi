...
public class Supplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 80, 20));

        kodeTF.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        kodeTF.setDisabledTextColor(new java.awt.Color(51, 51, 255));
        jPanel1.add(kodeTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 100, -1));
        ...
        jPanel1.add(cariBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, 40, 20));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel3.setText("Nama");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 50, -1));
        jPanel1.add(namaTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, 420, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 150, 380, 60));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel5.setText("No. Telepon");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 70, 20));
        jPanel1.add(telpTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, 190, -1));
        ...
        jPanel1.add(tambahBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 100, -1));
        ...
        jPanel1.add(simpanBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 250, 90, -1));
        ...
        jPanel1.add(editBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 250, 80, -1));
        ...
        jPanel1.add(hapusBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 250, 90, -1));
        ...
        jPanel1.add(keluarBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 250, 80, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 510, 170));
    ...
    private void cariBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariBTActionPerformed
        ...
        jTable1.setModel(data);
        setKoneksi();
        String sql="Select * from tbsupplier where kdsupplier like '%" + cari + "%'" + "or nmsupplier like '%" 
                + cari+  "%'" + "or alamat like '%" + cari+  "%'" + "or telp like '%" + cari+"%'";
        try {
            ResultSet rs=st.executeQuery(sql);
            while (rs.next())
            {
        ...
        if(namaTF.getText().isEmpty() ||alamatTF.getText().isEmpty()||telpTF.getText().isEmpty()){
            ...
            if(tambahBT.getText().equalsIgnoreCase("batal")){
                if(tambahBT.getText().equalsIgnoreCase("batal")){
                    ...
                    JOptionPane.showMessageDialog(null, "Simpan data gagal, periksa kembali","Smart Shop",
            ...
            if(editBT.getText().equalsIgnoreCase("batal")){
                if(editBT.getText().equalsIgnoreCase("batal")){
                    ...
                    JOptionPane.showMessageDialog(null, "Edit data gagal, periksa kembali","Smart Shop",
                            JOptionPane.INFORMATION_MESSAGE);
                }
            }
            bersih();
    ...
    private void hapusBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusBTActionPerformed
        // TODO add your handling code here:
        int pesan=JOptionPane.showConfirmDialog(null, "Yakin data akan dihapus ?","Konfirmasi",
