...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Login Aplikasi | Smart Shop");
        setResizable(false);
        ...
        jPanel1.add(nameTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, 240, 20));

        passTF.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jPanel1.add(passTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 240, 20));

        aksesCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pemilik", "Kasir", "Persediaan" }));
        jPanel1.add(aksesCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 161, 20));

        loginBT.setBackground(new java.awt.Color(255, 204, 204));
        loginBT.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        loginBT.setText("Login");
        loginBT.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 102, 0)));
        loginBT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                loginBTActionPerformed(evt);
            }
        });
        jPanel1.add(loginBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 160, 60, 30));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 160, 70, 30));
        ...
        getAccessibleContext().setAccessibleName("Login Aplikasi | Smart Shop"); // NOI18N
        ...
        if(nameTF.getText().equals("") || passTF.getText().equals("")|| aksesCB.getSelectedItem().equals("")){
            ...
            try {
                ...
                if(rs.getRow()>=1){
                    ...
                    JOptionPane.showMessageDialog(null,"Username, password atau hak akses tidak sesuai","Smart ", JOptionPane.WARNING_MESSAGE);
                    nameTF.grabFocus();
                }
            } catch (Exception e) {
            }
